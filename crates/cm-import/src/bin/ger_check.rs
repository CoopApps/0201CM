...
fn main() {
    ...
    let options = NewGameOptions { selected_nations: vec!["Germany".to_string()], background_nations: vec![], use_real_players: true, attribute_masking: true, start_year: 2001 , initial_game_rng_state: None };
