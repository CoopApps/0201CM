...
fn main() {
    ...
    let mut save=world.new_game_from_rust_db(path,&NewGameOptions{selected_nations:vec!["Greece".to_string()],background_nations:vec![],use_real_players:true,attribute_masking:true,start_year:2001});
