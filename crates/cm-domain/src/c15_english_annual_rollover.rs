...
impl Default for ClubYearEndState {
    fn default() -> Self {
        Self {
            ...
            cash: 0,
            season_subsidy_income: 0, lifetime_subsidy_income: 0,
    ...
    for pm in &decision.promoted {
        ...
        if let Some(req) = &effects.stadium_expansion {
            ...
            let c14_input = c13_request_to_c14_input(
                ...
                state.cash,
                state.season_subsidy_income, state.lifetime_subsidy_income,
                state.season_misc_expense, state.lifetime_misc_expense,
                parent,
                0, // news_ctx
